...
Original file is located at
    https://colab.research.google.com/drive/1ff2PRlvsjm_vZG5ZVM-LaZqyDuMz5MG4
"""
    ...
    while n < n_P:
        ...
        if (
            ...
            if lab_ag[i][j] == pelota:
                n += 1
                print("  Se agarro la " + str(n) + " pelota")
...
c = 8#int(input("Introduzca la cantidad de columnas del laberinto: "))
f = 7#int(input("Introduzca la cantidad de filas del laberinto: "))
n_Pelota = 2#int(input("Introduzca la cantidad de pelotas del laberinto: "))
n_Pared = 35#int(input("Introduzca la cantidad de muros del laberinto: "))
